🍽️ Sistema de Biblioteca (Backend - Spring Boot)
...
CRUD de Itens: Gerenciamento completo (Criação, Leitura, Atualização e Deleção) de Autores e Livros.
Endpoints Otimizados: API RESTful para consulta de Autores e Livros.
